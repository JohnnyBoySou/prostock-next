...
export const importSupplier = async (id: any, data: any) => {
    try {
        const res = await fetchWithAuthOtherStore("/usuarios/upload/fornecedores", { method: "POST", data: {"csv": data}, headers: { "lojaid": id.store } });
        return res;
    } catch (error: any) {
        throw new Error(error.message);
    }
